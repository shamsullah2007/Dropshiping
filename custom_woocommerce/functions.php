...
{
    wp_enqueue_style('custom-woocommerce-style', get_stylesheet_uri(), [], '1.0.8');
    wp_enqueue_style('custom-woocommerce-cj-single-product', get_template_directory_uri() . '/assets/css/cj-single-product.css', [], '1.0.8');
    wp_enqueue_script(
...
function custom_woocommerce_override_product_template($template) {
    if (is_product()) {
        // Remove only specific default WooCommerce hooks (keep price and add to cart)
